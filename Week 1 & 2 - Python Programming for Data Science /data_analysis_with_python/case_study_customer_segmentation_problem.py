...
agg_df["customer_level_based"] = (agg_df["COUNTRY"] + "_" + agg_df["SOURCE"] + "_" + agg_df["SEX"] + "_" + agg_df["AGE_CAT"].astype(str))
...
agg_df[agg_df["customer_level_based"] == new_user]["PRICE"].mean()
