...
# Normallik Varsayımı (Veri normal dağılıma sahip mi değil mi diye hipotez testi uygulayacağız)
# Varyans Homojenliği
...
# shapiro metodu bir dağılımın normal olup olmadığını kontrol eder
...
# Sonuç olarak bu problem için normallik varsayımı sağlanmamaktadır
