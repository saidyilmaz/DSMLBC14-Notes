...
df_train = pd.read_csv("Week 8 - Machine Learning II/house-prices-advanced-regression-techniques/train.csv")
df_test = pd.read_csv("Week 8 - Machine Learning II/house-prices-advanced-regression-techniques/test.csv")
...
### Adım 5: Kategorik değşken ile hedef değişken analizi yapınız
...
### GÖREV 2: ÖZELLİK MÜHENDİSLİĞİ İŞLEMLERİNİ GERÇEKLEŞTİRİNİZ ###

### Adım 1: Aykırı değer analizi
...
missing_values_table(df)  # SalesPrice hariç hiç eksik değer kalmadı.
...
### Adım 3: Yeni değişkenler oluşturunuz ve oluşturduğunuz yeni değişkenlerin başına 'NEW' ekleyiniz.
...
### Adım 4: Değişkenlerin önem düzeyini belirten feature_importance fonksiyonunu kullanarak özelliklerin sıralamasını çizdiriniz.
...
### Bonus: test dataframe indeki boş olan salePrice değişkenlerini tahminleyiniz.
...
# eğitilmiş modeli kullanarak test veri seti üzerinde tahmin yapıyoruz. Test veri setinden "Id" ve "SalePrice"
# sütunları çıkarıyoruz çünkü bu tahminleri yapmak gereksizdir.
