...
df = pd.read_csv("Week 8-9 - Machine Learning/datasets/diabetes.csv")
...
# Confusion matrix
print(classification_report(y, y_pred))  # sonuçların hepsi 1 çıktı, model %100 doğru çalışıyor demek bu. Gerçekçi değil
